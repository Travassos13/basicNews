                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Cadastrar classificados</li>
                        </ol>
                    </div>
                    <div class="container-fluid px-4">
                        <small>Formulário de cadastro de classificados</small>
                        <form action="config/cadastraProduto.jsp" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label">Nome do classificado</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Valor do classificado</label>
                                <input type="text" class="form-control" name="valor" placeholder="Valor do produto"/> 
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Imagem do classificado</label>
                    ...
                    <div class="container-fluid px-4">
                        <hr>
                        <small>Classificados cadastrados</small>
                        <hr>
                            ...
                            <tbody>
                                <% 
                                    ...
                                    try{
                                         ...
                                         rs = st.executeQuery("SELECT *FROM classificados ORDER BY nome ASC");
                                         while(rs.next()){ 
                                    ...
                                    <td>
                                         <a href="editarClassificados.jsp?id=<% out.print(id) ; %>" class="text-info" ><i class="fa fa-pencil-square"></i></a>
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Excluir classificado</h1>
                   ...
                   <%
                        if(request.getParameter("funcao")!= null && request.getParameter("funcao").equals("excluir")){
                            ...
                            try{
                                ...
                                con = DriverManager.getConnection(url,usuario,senhaBD);
                                st = con.createStatement();
                                st.executeUpdate("DELETE from classificados WHERE id = '"+id+"' ");
