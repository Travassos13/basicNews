                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Gerenciar Matérias</li>
                        </ol>
                    </div>
                    <%
                        ...
                        try {
                            ...
                            while(rs.next()){ %>
                                <div class="container-fluid px-4">
                                    <small>Formulário de atualização de matérias</small>
                                    <form action="config/editarMaterias.jsp?id=<%=rs.getString("id")%>&foto=<%=rs.getString("foto")%>" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="<%=rs.getString("titulo")%>" name="titulo" placeholder="Informe o título" />
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Matéria</label>
                                            <input type="text" class="form-control" value="<%=rs.getString("texto")%>" name="texto" placeholder="Informe a publicação" />
                                        </div>
                                        <div class="mb-3">
